#include "aes.h"
void aes::roxword(gf28 word[4][4], w keyword[4])
{
	for (int i = 0; i < 4; i++) {
		for (int j = 0; j < 4; j++) {
...
void aes::col_mix(gf28 word[4][4])
{
	gf28 r[4][4];
	gf28 temp[4][4];
	r[0][0] = 0x02;
...
void aes::i_col_mix(gf28 word[4][4])
{
	gf28 temp[4][4];
	gf28 r[4][4];
	r[0][0] = 0x0e;
...
void aes::encryption(unsigned char words[16])
{
	gf28 temp[4][4];
	for (int i = 0; i < 4; i++)
		for (int j = 0; j < 4; j++) {
...
void aes::decrypt(unsigned char words[16])
{
	gf28 temp[4][4];
	for (int i = 0; i < 4; i++)
		for (int j = 0; j < 4; j++) {
